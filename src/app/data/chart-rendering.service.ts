...
export class ChartRenderingService {
  ...
  /**
   * Renders the neutron-star jet-angle sample data (CSV) as a bubble plot and returns
   * it as a PNG data URL, or null when there is nothing to plot.
   */
  generateJetAngleChart(csv: string): string | null {
